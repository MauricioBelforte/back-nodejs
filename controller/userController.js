...
const storage = multer.diskStorage(
    {
        destination: function (req,file,cb){
            cb(null,'uploads/usuarios');//Indica la carpeta donde se guardaran los archivos
        },
...
const crearUsuario = (req, res) =>{
    ...
    const sql = 'INSERT INTO usuarios (nombre,apellido,email,password,url_imagen) VALUES (?,?,?,?,?)';


    db.query(sql,[nombre,apellido,mail,password,archivo], (err,result) =>
    {
        if(err) throw err;
